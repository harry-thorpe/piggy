...
switched_region_divergences_subset <- switched_region_divergences[(switched_region_divergences$Nuc_identity < 0.9 & switched_region_divergences$Length_identity < 0.9), ]
